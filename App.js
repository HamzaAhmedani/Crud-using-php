...
constructor(props) {
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('http://172.16.3.106/crud/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('http://172.16.3.106/crud/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('http://172.16.3.106/crud/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('http://172.16.3.106/crud/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
